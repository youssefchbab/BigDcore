...
end entity Alu_cntr2;

architecture Behavioral of Alu_cntr2 is

    -- RISC-V Opcodes (relevant for ALU operation determination)
    constant OPCODE_LOAD         : std_logic_vector(6 downto 0) := "0000011";
    constant OPCODE_STORE        : std_logic_vector(6 downto 0) := "0100011";
    constant OPCODE_BRANCH       : std_logic_vector(6 downto 0) := "1100011";
    constant OPCODE_ITYPE_ARITH  : std_logic_vector(6 downto 0) := "0010011";
    constant OPCODE_RTYPE_ARITH  : std_logic_vector(6 downto 0) := "0110011";
    ...
    -- Note: ALU_OP_COPY_B has been removed as LUI will now use ADD.
...
begin
    ...
    begin
        ...
        case Opcode_i is
            ...
            when OPCODE_LUI => -- Load Upper Immediate (0 + immediate_shifted)
                ALUOp_o <= ALU_OP_ADD; -- The main control will set ALU input A to 0 and B to imm_U_shifted
