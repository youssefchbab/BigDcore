...
Begin 
    process(RsD1, Lw_stall, Writeback_cntr, Pc_Select, RsD2, RsE1, RsE2, RdE,RdM,RdW, RegWriteM, RegWriteW) Begin
                --Forwards to Reg1
        if(RdM=RsE1 and RegWriteM='1' and RsE1/= "00000") then
            ForwardA<= "10";
                
        elsif(RdW=RsE1 and RegWriteW='1' and RsE1/= "00000") then
            ForwardA<= "01";
        else
            ForwardA<= "00";
        end if;
            --Forwards to Reg2
        if(RdM=RsE2 and RegWriteM='1' and RsE2/= "00000") then
            ForwardB<= "10";
